...
function stop(packet){
    ...
    ws.send('set joint_control[2].control.mode 0 ');
    ws.send('set joint_control[2].control.speed 0 ');
    ws.send('set joint_control[3].control.mode 0 ');
    ws.send('set joint_control[3].control.speed 0 ');
    sendPacket('joint_control[0]');
    sendPacket('joint_control[1]');
    sendPacket('joint_control[2]');
    sendPacket('joint_control[3]');
}
