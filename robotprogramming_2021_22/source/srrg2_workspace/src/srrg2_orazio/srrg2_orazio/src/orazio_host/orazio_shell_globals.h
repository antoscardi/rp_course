...
extern "C" {
  ...
  extern JointStatusPacket joint_status[NUM_JOINTS_MAX];
  extern JointParamPacket joint_params[NUM_JOINTS_MAX];
  extern JointControlPacket joint_control[NUM_JOINTS_MAX];
