...
struct UART* UART_init(const char* device __attribute__((unused)), uint32_t baud) {
  ...
  case 230400: setBaud230400(); break;
  case 576000: setBaud576000(); break;
  case 921600: setBaud921600(); break;
  default: return 0;
  }
